namespace ascad
{
    ...
    public class FrmLejant : Form
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.listBox1.Size = new Size(0x8e, 0x105);
            this.listBox1.TabIndex = 0;
            this.listBox1.SelectedIndexChanged += new EventHandler(this.listBox1_SelectedIndexChanged);
            base.AutoScaleDimensions = new SizeF(6f, 13f);
            base.AutoScaleMode = AutoScaleMode.Font;
            base.ClientSize = new Size(0x8e, 0x105);
        ...
        {
            yazilar selectedItem = this.listBox1.SelectedItem as yazilar;
            Clipboard.SetDataObject(selectedItem.nedurki, false);
        }
    }
}
