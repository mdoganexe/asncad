namespace ascad
{
    ...
    public class FrmOkul : Form
    {
        ...
        {
            ComponentResourceManager manager = new ComponentResourceManager(typeof(FrmOkul));
            ...
            base.SuspendLayout();
            this.textBox1.Location = new Point(0xb5, 0x27);
            this.textBox1.Name = "textBox1";
            this.textBox1.Size = new Size(0x3d, 0x18);
            this.textBox1.TabIndex = 4;
            this.textBox1.Text = "0";
            this.textBox1.TextChanged += new EventHandler(this.textBox1_TextChanged);
            this.textBox1.KeyPress += new KeyPressEventHandler(this.textBox1_KeyPress);
            this.label4.AutoSize = true;
            this.label4.Location = new Point(0x2f, 0x88);
            this.label4.Name = "label4";
            this.label4.Size = new Size(0x3a, 0x12);
            this.label4.TabIndex = 3;
            this.label4.Text = "Toplam";
            this.label3.AutoSize = true;
            this.label3.Location = new Point(0x15, 0x55);
            this.label3.Name = "label3";
            this.label3.Size = new Size(0x93, 0x12);
            ...
            this.groupBox1.Location = new Point(0x1f, 0x1d);
            this.groupBox1.Name = "groupBox1";
            this.groupBox1.Size = new Size(0x100, 0xd1);
            this.groupBox1.TabIndex = 1;
            this.groupBox1.TabStop = false;
            this.groupBox1.Text = "OKUL";
            this.button1.Location = new Point(0x67, 0xa8);
            ...
            this.textBox2.Location = new Point(0xb5, 0x52);
            this.textBox2.Name = "textBox2";
            this.textBox2.Size = new Size(0x3d, 0x18);
            ...
            this.label2.Size = new Size(0x4f, 0x12);
            this.label2.TabIndex = 1;
            this.label2.Text = "Sınıf Sayısı";
            this.label1.AutoSize = true;
            this.label1.Location = new Point(0xbd, 0x88);
            ...
            base.ClientSize = new Size(0x13e, 0x10a);
            base.Controls.Add(this.groupBox1);
            base.MaximizeBox = false;
            this.MaximumSize = new Size(0x14e, 0x131);
            base.MinimizeBox = false;
            this.MinimumSize = new Size(0x14e, 0x131);
            base.Name = "FrmOkul";
