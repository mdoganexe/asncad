...
namespace ascad
{
	public class FrmHesaplama : Form
	{
		...
		private void InitializeComponent()
		{
			...
			ComponentResourceManager componentResourceManager = new ComponentResourceManager(typeof(FrmHesaplama));
			...
			this.dataGridView1.Size = new Size(1267, 662);
			...
			this.button1.Location = new Point(593, 669);
			...
			base.ClientSize = new Size(1297, 539);
			...
			this.Text = "ELEKTRİKLİ ASANSÖR HESAP ÖZETİ";
