...
namespace ascad
{
	public class FrmHesaplama3 : Form
	{
		...
		private void InitializeComponent()
		{
			...
			ComponentResourceManager componentResourceManager = new ComponentResourceManager(typeof(FrmHesaplama3));
			...
			this.dataGridView1.Size = new Size(1172, 465);
			...
			this.button1.Font = new Font("Microsoft Sans Serif", 9.75f, FontStyle.Bold, GraphicsUnit.Point, 162);
			this.button1.ImageAlign = ContentAlignment.MiddleLeft;
			this.button1.Location = new Point(543, 492);
			this.button1.Name = "button1";
			this.button1.Size = new Size(106, 39);
			...
			base.ClientSize = new Size(1192, 545);
			...
			this.Text = "HİDROLİK ASANSÖR HESAP ÖZETİ";
