	...
	public class teknikdosyaekle : Form
	{
		...
		public void dil(string ney)
		{
			try
			{
				...
				this.layoutControlItem1.set_Text(arrayList[357].ToString());
				this.layoutControlItem7.set_Text(arrayList[358].ToString());
				this.layoutControlItem5.set_Text(arrayList[359].ToString());
				this.layoutControlItem3.set_Text(arrayList[360].ToString());
				this.asdg.set_Text(arrayList[361].ToString());
				this.simpleButton1.Text = arrayList[362].ToString();
				this.simpleButton2.Text = arrayList[363].ToString();
				this.simpleButton3.Text = arrayList[364].ToString();
				this.simpleButton4.Text = arrayList[365].ToString();
			}
			catch (Exception)
			{
		...
		public string yy()
		{
			...
			{
				StreamWriter streamWriter = new StreamWriter("C:\\SZGBKM\\asnhata.txt", true);
				streamWriter.WriteLine("üretici verilerini içeri aktarırken sorun oldu;" + ex.Message);
				streamWriter.Close();
			}
			return result;
		}
						...
						else
						{
							...
							else
							{
								...
								else
								{
									...
									for (int i = 0; i < dataTable.Rows.Count; i++)
									{
										bool flag6 = dataTable.Rows[i][0].ToString() == "";
										if (flag6)
										{
											num++;
										}
										...
										{
											num = Convert.ToInt32(dataTable.Rows[i][0]) + 1;
										}
									}
									try
									{
										...
										{
											"insert into tedarik (malzeme, uretici,model,serino,belgeveren,edit,gorunur,degisti,nobo) values('",
											this.malzeme.Text,
											"','",
											this.uretici.Text,
											"','",
									...
									{
										StreamWriter streamWriter = new StreamWriter("C:\\SZGBKM\\asnhata.txt", true);
										streamWriter.WriteLine("veritabanına yeni veriyi ekle ve resimi edit adıyla kaydet;" + ex.Message);
										streamWriter.Close();
									}
									finally
									{
		...
		public string resim(string ko)
		{
			...
			{
				StreamWriter streamWriter = new StreamWriter("C:\\SZGBKM\\asnhata.txt", true);
				streamWriter.WriteLine(ko + "asagasgasgasg;" + ex.Message);
				streamWriter.Close();
			}
			finally
			{
		...
		{
			ComponentResourceManager componentResourceManager = new ComponentResourceManager(typeof(teknikdosyaekle));
			...
			this.layoutControl1.Size = new Size(453, 340);
			...
			this.belgeveren.Size = new Size(339, 22);
			this.belgeveren.set_StyleController(this.layoutControl1);
			this.belgeveren.TabIndex = 13;
			this.belgeveren.add_EditValueChanged(new EventHandler(this.belgeveren_EditValueChanged_1));
			...
			this.simpleButton4.Location = new Point(7, 308);
			this.simpleButton4.Name = "simpleButton4";
			this.simpleButton4.Size = new Size(439, 23);
			...
			this.simpleButton3.Size = new Size(439, 23);
			...
			this.simpleButton2.Size = new Size(439, 23);
			...
			this.uretici.Size = new Size(339, 22);
			this.uretici.set_StyleController(this.layoutControl1);
			this.uretici.TabIndex = 11;
			this.uretici.add_EditValueChanged(new EventHandler(this.comboBox2_EditValueChanged));
			...
			this.model.Size = new Size(339, 22);
			this.model.set_StyleController(this.layoutControl1);
			this.model.TabIndex = 10;
			this.model.add_EditValueChanged(new EventHandler(this.model_EditValueChanged));
			...
			this.simpleButton1.Size = new Size(439, 23);
			...
			this.belgeno.Size = new Size(339, 22);
			this.belgeno.set_StyleController(this.layoutControl1);
			this.belgeno.TabIndex = 6;
			this.belgeno.add_EditValueChanged(new EventHandler(this.belgeno_EditValueChanged));
			...
			this.malzeme.Size = new Size(339, 22);
			this.malzeme.set_StyleController(this.layoutControl1);
			this.malzeme.TabIndex = 4;
			this.malzeme.add_EditValueChanged(new EventHandler(this.malzeme_EditValueChanged));
			...
			this.layoutControlGroup1.set_Size(new Size(453, 340));
			...
			this.layoutControlItem1.set_Size(new Size(443, 26));
			...
			this.layoutControlItem3.set_Size(new Size(443, 26));
			...
			this.layoutControlItem6.set_Size(new Size(443, 43));
			...
			this.layoutControlItem5.set_Size(new Size(443, 26));
			...
			this.layoutControlItem7.set_Size(new Size(443, 26));
			...
			this.layoutControlItem2.set_Size(new Size(443, 43));
			...
			this.asdg.set_Size(new Size(443, 26));
			...
			this.layoutControlItem8.set_Size(new Size(443, 43));
			...
			this.layoutControlItem9.set_Location(new Point(0, 285));
			this.layoutControlItem9.set_Name("layoutControlItem9");
			this.layoutControlItem9.set_Size(new Size(443, 45));
			this.layoutControlItem9.set_Text(" ");
			this.layoutControlItem9.set_TextLocation(3);
			this.layoutControlItem9.set_TextSize(new Size(97, 13));
			...
			this.textEdit1.Size = new Size(339, 22);
			...
			this.layoutControlItem4.set_Size(new Size(443, 26));
			this.layoutControlItem4.set_Text("NOTİFİY BODY :");
			this.layoutControlItem4.set_TextSize(new Size(97, 16));
			base.AutoScaleDimensions = new SizeF(6f, 13f);
			base.AutoScaleMode = AutoScaleMode.Font;
			base.ClientSize = new Size(453, 340);
			base.Controls.Add(this.layoutControl1);
			this.MaximumSize = new Size(469, 379);
			this.MinimumSize = new Size(469, 379);
